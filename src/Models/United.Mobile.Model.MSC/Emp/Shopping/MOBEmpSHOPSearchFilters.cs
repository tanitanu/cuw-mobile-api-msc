...
{
    [Serializable()]
    public class MOBEmpSHOPSearchFilters
    {
        private string aircraftTypes = string.Empty;
        private string airportsDestination = string.Empty;
        private List<MOBEmpSHOPSearchFilterItem> airportsDestinationList;
        private string airportsOrigin = string.Empty;
        private List<MOBEmpSHOPSearchFilterItem> airportsOriginList;
        private string airportsStop = string.Empty;
        private List<MOBEmpSHOPSearchFilterItem> airportsStopList;
        private string airportsStopToAvoid = string.Empty;
        private List<MOBEmpSHOPSearchFilterItem> airportsStopToAvoidList;
        ...
        private List<MOBEmpSHOPSearchFilterItem> carriersMarketingList;
        private string carriersOperating = string.Empty;
        private List<MOBEmpSHOPSearchFilterItem> carriersOperatingList;
        ...
        private List<MOBEmpSHOPSearchFilterItem> equipmentList;
        private string equipmentTypes = string.Empty;
        private List<MOBEmpSHOPFareFamily> fareFamilies;
        ...
        private List<MOBEmpSHOPSearchFilterItem> warningsFilter;
        private int pageNumber = 1;
        private string sortType1 = string.Empty;
        private List<MOBEmpSHOPSearchFilterItem> sortTypes;
        private List<MOBEmpSHOPSearchFilterItem> numberofStops;
        private List<MOBEmpSHOPSearchFilterItem> amenityTypes;
        private List<MOBEmpSHOPSearchFilterItem> carrierTypes;
        private List<MOBEmpSHOPSearchFilterItem> aircraftCabinTypes;
        ...
        public List<MOBEmpSHOPSearchFilterItem> AirportsDestinationList { get { return this.airportsDestinationList; } set { this.airportsDestinationList = value; } }
        ...
        public List<MOBEmpSHOPSearchFilterItem> AirportsOriginList { get { return this.airportsOriginList; } set { this.airportsOriginList = value; } }
        ...
        public List<MOBEmpSHOPSearchFilterItem> AirportsStopList { get { return this.airportsStopList; } set { this.airportsStopList = value; } }
        ...
        public List<MOBEmpSHOPSearchFilterItem> AirportsStopToAvoidList { get { return this.airportsStopToAvoidList; } set { this.airportsStopToAvoidList = value; } }
        ...
        public List<MOBEmpSHOPSearchFilterItem> CarriersMarketingList { get { return this.carriersMarketingList; } set { this.carriersMarketingList = value; } }
        ...
        public List<MOBEmpSHOPSearchFilterItem> CarriersOperatingList { get { return this.carriersOperatingList; } set { this.carriersOperatingList = value; } }
        ...
        public List<MOBEmpSHOPSearchFilterItem> EquipmentList { get { return this.equipmentList; } set { this.equipmentList = value; } }
        ...
        public List<MOBEmpSHOPFareFamily> FareFamilies { get { return this.fareFamilies; } set { this.fareFamilies = value; } }
        ...
        public List<MOBEmpSHOPSearchFilterItem> WarningsFilter { get { return this.warningsFilter; } set { this.warningsFilter = value; } }
        ...
        public List<MOBEmpSHOPSearchFilterItem> SortTypes { get { return this.sortTypes; } set { this.sortTypes = value; } }
        public List<MOBEmpSHOPSearchFilterItem> NumberofStops { get { return this.numberofStops; } set { this.numberofStops = value; } }
        public List<MOBEmpSHOPSearchFilterItem> AmenityTypes { get { return this.amenityTypes; } set { this.amenityTypes = value; } }
        public List<MOBEmpSHOPSearchFilterItem> AircraftCabinTypes { get { return this.aircraftCabinTypes; } set { this.aircraftCabinTypes = value; } }
        public List<MOBEmpSHOPSearchFilterItem> CarrierTypes { get { return this.carrierTypes; } set { this.carrierTypes = value; } }
