...
{
    [Serializable]
    public class MOBEmpSegmentResponse
    {
        ...
        private MOBEmpMessageCode upgradeMessageCode;
        private List<MOBEmpUpgradePropertyKeyValue> upgradeProperties;
        private MOBEmpUpgradeEligibilityStatus upgradeStatus;
        private MOBEmpUpgradeType upgradeType;
        private List<MOBEmpSegmentResponse> waitlistSegments;
        ...
        public MOBEmpMessageCode UpgradeMessageCode
        {
            get
            {
        ...
        public List<MOBEmpUpgradePropertyKeyValue> UpgradeProperties
        {
            get
            {
        ...
        public MOBEmpUpgradeEligibilityStatus UpgradeStatus
        {
            get
            {
        ...
        public MOBEmpUpgradeType UpgradeType
        {
            get
            {
        ...
        public List<MOBEmpSegmentResponse> WaitlistSegments
        {
            get
            {
