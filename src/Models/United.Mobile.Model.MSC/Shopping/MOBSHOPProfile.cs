...
namespace United.Definition.Shopping
{
    ...
    public class MOBSHOPProfile
    {
        ...
        private List<MOBSHOPProfileMember>profileMembers;
        ...
        private List<MOBSHOPProfileTraveler>travelers;
        ...
        public List<MOBSHOPProfileMember> ProfileMembers
        {
            get
            {
        ...
        public List<MOBSHOPProfileTraveler> Travelers
        {
            get
            {
