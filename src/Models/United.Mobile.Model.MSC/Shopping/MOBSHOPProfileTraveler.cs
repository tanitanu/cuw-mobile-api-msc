...
{
    [Serializable()]
    public class MOBSHOPProfileTraveler
    {
        private string mileagePlusNumber;
        private long customerId;
        private MOBSHOPPerson name;
        ...
        private List<MOBSHOPLoyaltyProgramProfile> airRewardPrograms;
        private string key;
        ...
        public List<MOBSHOPLoyaltyProgramProfile> AirRewardPrograms
        {
            get
            {
